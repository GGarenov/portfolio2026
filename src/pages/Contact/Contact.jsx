    ...
    <section className="contact section" id="contact">
      <div className="container">
        <header className="contact-header">
          ...
          <h2 className="contact-title">Let&apos;s meet and talk</h2>
          <p className="contact-subtitle">
            Interested in collaborating or have a job in mind? Reach out and
        ...
        <div className="contact-content">
          <div className="contact-links">
            ...
            >
              ...
              <span className="contact-link-subtitle">
                Grab a PDF copy of my latest CV.
              </span>
            </a>
            ...
            >
              ...
              <span className="contact-link-subtitle">
                You can check part of my visible projects and activity.
              </span>
            </a>
            ...
            >
              ...
              <span className="contact-link-subtitle">
                We can connect and share some toughts on Linkedin as well.
              </span>
            </a>
          </div>
        </div>
